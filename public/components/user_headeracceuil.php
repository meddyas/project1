...
<header class="bg-white shadow-md">
        ...
        <nav class="space-x-4">
            ...
            <a href="home.php" class="text-gray-800 text-3xl hover:text-blue-600">Shop Now</a>
            <a href="cours.php" class="text-gray-800 text-3xl hover:text-blue-600">Activity</a>
            <a href="membership.php" class="text-gray-800 text-3xl hover:text-blue-600">Subscription</a>
